...
gp.initPotree("gigapoint_resource/config/gigapoint_century_hres_cave2.json")
...
#mi.optimize = True
mi.optimize = False
mi.path = "/cave/omegalib/apps/baybridge/baybridge/baybridge/T1Block01A_OneQuarter_StructSteel_noPiles.fbx"
